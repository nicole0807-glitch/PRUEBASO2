...
public class MainFrame extends JFrame {
    ...
    private String getSelectedPath(){
        String tablePath=getSelectedPathFromTable();
        if(tablePath!=null) return tablePath;
    ...
    private void refreshDiskPanel(){
        ...
        int total=d.size();
        updateDiskInfoLabel(free,total);
    ...
    private void updateDiskInfoLabel(int free,int total){
        boolean full=free==0;
        diskInfoLabel.setText("Bloques libres: "+free+" / "+total+(full?" (Memoria llena)":""));
        diskInfoLabel.setForeground(full?Color.RED:Color.BLACK);
    }
